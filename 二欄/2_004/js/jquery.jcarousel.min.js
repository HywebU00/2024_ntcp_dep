...
(function (g) {
  ...
  g.jcarousel = function (a, c) {
    ...
    if (this.buttonPrev.size() === 0 && this.options.buttonPrevHTML !== null) this.buttonPrev = g(this.options.buttonPrevHTML).prependTo(this.container);
